...
namespace Sels.TextTemplateEngine.Compilation.Lexing.Tokens
{
    ...
    /// </summary>
    public class InvocationNamedParameterStartToken : BaseSequenceToken
    {
        // Statics
        ...
        /// <inheritdoc/>
        public override string Type => TextTemplateEngineConstants.Compilation.TokenTypes.InvocationNamedParameterStart;
    }
}
