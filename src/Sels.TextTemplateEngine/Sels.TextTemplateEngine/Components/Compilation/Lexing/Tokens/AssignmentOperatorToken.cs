...
namespace Sels.TextTemplateEngine.Compilation.Lexing.Tokens
{
    ...
    /// </summary>
    public class AssignmentOperatorToken : BaseSequenceToken, ITextTemplateTypedToken
    {
        // Statics
        ...
        /// <inheritdoc/>
        public static string TokenType => TextTemplateEngineConstants.Compilation.TokenTypes.AssignmentOperator;
        /// <inheritdoc/>
